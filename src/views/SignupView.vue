...
import { signup, getRegistrationMetaData } from '../services/authService'
      ...
      <div class="col-md-6 d-flex align-items-center justify-content-center bg-white left-scroll">
        ...
        <div class="login-box">
          ...
          <div class="text-center mb-4">
            <h3 class="mt-3">{{ $t('create_your_account') }}</h3>
            <p class="text-muted">{{ $t('create_your_account_to_manage_your_business') }}</p>
          </div>
          ...
          <div class="mb-5">
            <p class="line-around text-secondary mb-0"><span class="line-around-1">OR</span></p>
          </div>

          <SignupForm @signup="handleSignup" :registrationMetaData="registrationMetaData" :loading="loading" />
        </div>
      </div>
