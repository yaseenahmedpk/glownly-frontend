...
<template>
    <Vue3EasyDataTable :headers="headers" :items="roles" :loading="loading" :search-field="true" :search-value="''"
        :sort-by="'id'" :sort-type="'asc'" :rows-per-page="10" :rows-per-page-message="'Rows per page:'"
        ...
        <template #item-action="item">
            <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="18" style="color:green;cursor: pointer;"
                    ...
                    class="size-6" v-tooltip="{ text: 'Edit Role', placement: 'left' }">
