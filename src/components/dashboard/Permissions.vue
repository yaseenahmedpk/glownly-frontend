        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr v-for="permission in permissions" :key="permission.id">
                    ...
                    <td>{{ permission.roles.name }}</td>
                    <td>
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" style="color:green;cursor: pointer;"
                            @click="selectPermission(permission)" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" style="color:red;cursor: pointer;"
                            @click="deletePermission(permission)" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 ml-2"
                ...
                <td colspan="3" class="text-center">
                    ...
                    <span v-else-if="permissions.length === 0">No data found</span>
                </td>
            </tbody>
        </table>
    </div>
