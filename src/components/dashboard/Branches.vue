...
import { updateQrCode } from '../../services/branchService';
...
const emit = defineEmits(['branchData', 'deleteBranch', 'qrCodeUpdated'])
...
const showQrCode = (branchId, branchName, qrcodeUrl) => {
    modalTitle.value = branchName;
        ...
        <template #item-action="item">
            <div>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="18" style="color:blue;cursor: pointer;"
                    @click="showQrCode(item.id, item.name, item.qr_code_url)" fill="none" viewBox="0 0 24 24"
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="d-flex gap-3">
                        ...
                        <button type="button" class="btn btn-success ml-2" @click="printQrCode">Print</button>
                    </div>
                </div>
            </div>
        </div>
